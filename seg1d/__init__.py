...
def sampleData(c=0.8):
    ...
    with open(data_dir+os.sep+'refData.pickle','rb') as f: refData = pickle.load(f)
    with open(data_dir+os.sep+'targData.pickle','rb') as f: targData = pickle.load(f)
    with open(data_dir+os.sep+'weights.pickle','rb') as f: refWeights = pickle.load(f)
